const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-06-8', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: 'Share Programme',
  HERO_TITLE_2: 'Gourmet',
  HERO_TITLE_3: 'ART',
  HERO_TITLE_4: 'Click here',
  HERO_TITLE_5: 'Check my resume',
  HERO_TITLE_LINK: 'www.linkedin.com/in/tongdeqiang',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: 'Programme', url: '/tag/Programme' },
  HERO_CATEGORY_2: { title: 'Gourmet', url: '/tag/Gourmet' },
  ...
  INFO_CARD_URL: 'www.linkedin.com/in/tongdeqiang', // 个人资料底部按钮链接
